...
public class SeleniumCVV {
    ...
    @Before
    public void setUp() {
        System.setProperty("webdriver.gecko.driver", "C:\\Users\\2105094046\\Drivers\\geckodriver.exe");
   ...
   /* @Test
    public void inserirDadosParaCadastro() {
        ...
        driver.findElement(By.name("nome")).sendKeys("Guilherme Aulik");
        driver.findElement(By.name("email")).sendKeys("niketestes@gmail.com");
    ...
    @Test
    public void validarCadastrarUmProduto() {
